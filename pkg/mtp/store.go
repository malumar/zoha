...
func DefaultNewFileFromDelivery(proxy MessageReceiverProxy, delivery Delivery, hostName string,
	baseStoragePath string) (filename string, dataSize int64, err error) {
	return NewFileFromMailboxDelivery(proxy, delivery, hostName, baseStoragePath, DefaultFolderPerm, DefaultFilePerm)
}

func NewFileFromMailboxDelivery(proxy MessageReceiverProxy, delivery Delivery, hostName string, baseStoragePath string,
	folderPerm, filePerm os.FileMode) (filename string, dataSize int64, err error) {
